...
<head>
    ...
    <title>Create New Service - BookingApp</title>
    ...
    <div class="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>Only company administrators can create new services.</p>
                        </div>
                        <div class="mt-4">
        ...
        @else
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Add a new service to your business offerings</p>
            </div>

            <!-- Service Form -->
            <div class="bg-white shadow rounded-lg overflow-hidden">
                <form action="{{ route('services.store') }}" method="POST" class="px-6 py-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">{{ old('description') }}</textarea>
                        <p class="mt-2 text-sm text-gray-500">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 bg-white">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <h5 id="preview-name" class="font-semibold text-gray-900">Your Service Name</h5>
                                    <p id="preview-description" class="text-sm text-gray-600 mt-1">Service description will appear here</p>
                                </div>
                                <div class="text-right">
                                    <p id="preview-price" class="text-lg font-bold text-purple-600">$0.00</p>
                                    <p id="preview-duration" class="text-sm text-gray-500">60 minutes</p>
                                </div>
                            </div>
                        </div>
